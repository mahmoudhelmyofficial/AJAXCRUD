...
namespace CRUDWithAJAX.Controllers
{
    public class EmployersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Company,Age")] Employer employer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Company,Age")] Employer employer)
        {
            if (id != employer.Id)
            {
                return NotFound();
